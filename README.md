...
a lil silly CLI that keeps your Mac awake 24/7 while it runs, and lets you drive it from your phone

![status](https://img.shields.io/badge/status-rolling%20out-blueviolet)
![platform](https://img.shields.io/badge/platform-macOS%20%2B%20iPhone-black)

![image](https://s6.imgcdn.dev/YegHTo.png)
...
```bash
curl -fsSL https://flaude.com | sh
```

then open the app, scan once, done.
